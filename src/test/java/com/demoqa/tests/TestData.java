...
public class TestData {
    ...
    learningJSDesignPatternsTitle = "Learning JavaScript Design Patterns",
            ...
            programmingJSApplicationsTitle = "Programming JavaScript Applications",
            eloquentJSTitle = "Eloquent JavaScript, Second Edition",
            understandingECMAScript6Title = "Understanding ECMAScript 6";
